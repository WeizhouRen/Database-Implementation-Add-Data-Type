...
-- Assume the user defined functions are in /srvr/z5288155/postgresql-12.5/src/tutorial/complex$DLSUFFIX
...
CREATE FUNCTION complex_in(cstring)
   RETURNS complex
   AS '/srvr/z5288155/postgresql-12.5/src/tutorial/complex'
